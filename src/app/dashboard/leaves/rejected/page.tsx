...
export default function RejectedLeavesPage() {
  ...
  return (
    <div className="min-h-screen p-6 bg-gray-100">
          ...
          <div className="relative w-350 rounded-lg bg-white p-6 shadow-lg overflow-y-auto h-140">
           ...
           <div className="grid grid-cols-2 gap-4">
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <p className="mb-1 font-semibold text-gray-600">From:</p>
              ...
              <div>
                ...
                <span className={`px-3 py-1 rounded-full text-sm font-semibold ${getStatusColor(viewedLeave.status || 'Pending')}`}>
      ...
      {/* Leave Table */}
      <div>
        <h3 className="mb-4 text-xl font-semibold text-gray-700">Rejected Leave Table</h3>
        <Table
          columns={columns}
          data={leaves}
